          ...
          <div className='absolute right-0 mt-2 w-48 bg-black border border-gray-700 rounded-lg shadow-lg z-50'>
            {role !== "staff" && (
              <>
                ...
                <div>
                  <button
                    className='block w-full text-left px-4 py-2 hover:bg-gray-800 flex text-lg items-center justify-between'
            ...
            {isAuthenticated ? (
              ...
              <>
                <Link to='/login' className='block px-4 py-2 hover:bg-gray-800'>
                  ĐĂNG NHẬP
                </Link>
                <Link
                  to='/register'
          ...
          <>
            ...
            <div className='relative group'>
              ...
              <div className='absolute left-0 top-full max-w-64 w-56 bg-black border border-gray-700 rounded-lg hidden group-hover:block z-50'>
                <Link
                  to='/design/bang-gia-dong-phuc'
                  className='block px-4 py-2 hover:bg-gray-800 text-sm'>
                  BẢNG GIÁ ĐỒNG PHỤC
                </Link>
                <Link
                  to='/design/bang-gia-ao-lop'
                  className='block px-4 py-2 hover:bg-gray-800 text-sm'>
                  BẢNG GIÁ ÁO LỚP
                </Link>
                <Link
                  to='/design/bang-gia-phu-kien'
                  className='block px-4 py-2 hover:bg-gray-800 text-sm'>
                  BẢNG GIÁ PHỤ KIỆN
                </Link>
                <Link
                  to='/design/bang-gia-dich-vu'
                  className='block px-4 py-2 hover:bg-gray-800 text-sm'>
                  BẢNG GIÁ DỊCH VỤ
                </Link>
              </div>
