...
const Login = () => {
  ...
  useEffect(() => {
    ...
    // 2. Check if token is returned in URL (Google callback)
  ...
  const handleGoogleLogin = () => {
    if (googleLoginUrl.url) {
      window.location.href = googleLoginUrl.url;
    } else {
        ...
        <div className='w-full md:w-1/2 px-4 md:px-12'>
          ...
          <div className='relative my-6'>
            ...
            <div className='relative flex justify-center text-sm'>
              <span className='px-2 bg-[#dfa674] text-gray-500'>
                Hoặc đăng nhập với
              </span>
            </div>
          </div>
