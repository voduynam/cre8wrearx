  ...
  return (
    <div className='bg-black'>
      ...
      <div className='py-10 py-20'>
        <h2 className='text-center text-3xl font-black text-white font-sans'>
          CHÚNG TÔI LƯU GIỮ KỶ NIỆM CỦA BẠN TRÊN CHIẾC ÁO PHÔNG
        </h2>
        ...
        <div className='py-10'>
          ...
          <h2 className='text-center text-l  text-white font-sans'>
            Potato Clothing thiết kế và sản xuất nhiều loại sản phẩm đồng phục
            thẩm mỹ, chất lượng.
          </h2>
          <ProductGrid2 />
        </div>
